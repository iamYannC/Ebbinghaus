...
ui <- page_navbar(
  ...
  # --- Right-aligned nav items: GitHub + DOI ---------------------------------
  ...
  nav_item(
    tags$a(
      href = "https://doi.org/10.5281/zenodo.18906801",
      target = "_blank",
      title = "DOI: 10.5281/zenodo.18906801",
      class = "nav-link px-2",
      tags$img(src = "doi.svg", height = "20", style = "vertical-align: middle;")
    )
  ),
